...
module.exports = async (client, member) => {
    if (member.guild.id === SERV_UB) { // welcome message for UBreddit
        member.guild.channels.get(CHAN_UB_WELCOME).send("Howdy, <@!" + member.id + ">! Welcome to the UBreddit server! To start chatting, add and verify your phone to your Discord account or DM a staff member. Then head over to <#412827438322810891> and type `!role list` to get tags!");
    }
